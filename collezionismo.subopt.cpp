...
Lo tengo perchè è un esempio di riceca binaria con strategia greedy, 
che trova una soluzione subottima, ma non sempre l'ottima in assoluto.
Per la soluzione a questo problema vedi collezionismo.cpp
*/
